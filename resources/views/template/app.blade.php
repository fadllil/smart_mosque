...
<aside class="main-sidebar fixed offcanvas shadow">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview
                @if(Request::is('admin/administrator')) active @endif
                @if(Request::is('admin/admin_masjid')) active @endif
                @if(Request::is('admin/jamaah')) active @endif
                "><a href="#">
                    <i class="icon-sailing-boat-water purple-text"></i> <span>Manajemen Pengguna</span> <i
                        class="icon icon-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li><a href="/admin/administrator"><i class="icon icon-circle-o"></i>Administrator</a>
                    </li>
                    <li><a href="/admin/admin_masjid"><i class="icon icon-circle-o"></i>Admin Masjid</a>
                    </li>
                    <li><a href="/admin/jamaah"><i class="icon icon-circle-o"></i>Jamaah</a>
                    </li>
                </ul>
            </li>
            <li class="treeview"><a href="/admin/masjid">
                    <i class="icon-sailing-boat-water purple-text"></i> <span>Masjid</span>
                </a>
            </li>
        </ul>
    </section>
