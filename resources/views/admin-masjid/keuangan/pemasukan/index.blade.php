                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-10">
                                    <h6 class="card-title">Tabel Data Pemasukan Masjid</h6>
                                </div>
                        ...
                        <div class="card-body">
                            <table id="datatablePemasukan" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
            ...
            <div class="modal-content no-r ">
                ...
                <div class="modal-body no-p">
                    <div class="text-center p-t-20 p-b-0">
                        <h4>Tambah Pemasukan Masjid</h4>
                    </div>
                    <div class="light p-10 b-t-b">
                        <form action="/admin_masjid/pemasukan/create" method="post">
                            @csrf
    ...
    <script>
        $(function() {
            $('#datatablePemasukan').DataTable({
                ...
                serverSide: true,
                info: true,
                ajax: '/admin_masjid/pemasukan/datatable',
                columns: [{
                    "data": null,
                    'sortable': false,
